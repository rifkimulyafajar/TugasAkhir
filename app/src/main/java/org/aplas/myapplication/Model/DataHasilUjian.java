...
public class DataHasilUjian {
    ...
    public String getJml_benar ()
    {
        return jml_benar;
    }

    public void setJml_benar (String jml_benar)
    {
        this.jml_benar = jml_benar;
    }
    ...
    {
        return "ClassPojo [waktu_selesai = "+waktu_selesai+", level = "+level+", nilai = "+nilai+", jurusan = "+jurusan+", id_guru = "+id_guru+", id_mapel = "+id_mapel+", id_jurusan = "+id_jurusan+", jml_benar = "+jml_benar+", mapel = "+mapel+", id_siswa = "+id_siswa+", token = "+token+", password = "+password+", id_ujian = "+id_ujian+", nip = "+nip+", nama = "+nama+", judul_ujian = "+judul_ujian+", kelas = "+kelas+", jenis = "+jenis+", id_kelas = "+id_kelas+", id = "+id+", durasi = "+durasi+", waktu_mulai = "+waktu_mulai+", username = "+username+"]";
    }
}
