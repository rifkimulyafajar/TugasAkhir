...
public class DataBankSoal {
    ...
    private String file_c;

    private String file_d;

    private String file_e;
    ...
    public String getFile_b ()
    {
        return file_b;
    }

    public void setFile_b (String file_b)
    {
        this.file_b = file_b;
    }
    ...
    public String getFile_d ()
    {
        return file_d;
    }

    public void setFile_d (String file_d)
    {
        this.file_d = file_d;
    }

    public String getFile_e ()
    {
        return file_e;
    }

    public void setFile_e (String file_e)
    {
        this.file_e = file_e;
    }
    ...
    {
        return "ClassPojo [pilihan_a = "+pilihan_a+", pilihan_c = "+pilihan_c+", pilihan_b = "+pilihan_b+", pilihan_e = "+pilihan_e+", pilihan_d = "+pilihan_d+", id_mapel = "+id_mapel+", id_jurusan = "+id_jurusan+", password = "+password+", nip = "+nip+", file_a = "+file_a+", file_b = "+file_b+", kelas = "+kelas+", id_kelas = "+id_kelas+", file_soal = "+file_soal+", id_kategori = "+id_kategori+", level = "+level+", id_soal = "+id_soal+", file_c = "+file_c+", file_d = "+file_d+", file_e = "+file_e+", jurusan = "+jurusan+", id_guru = "+id_guru+", mapel = "+mapel+", kunci = "+kunci+", soal = "+soal+", nama = "+nama+", tanggal = "+tanggal+", status = "+status+", username = "+username+"]";
    }
}
